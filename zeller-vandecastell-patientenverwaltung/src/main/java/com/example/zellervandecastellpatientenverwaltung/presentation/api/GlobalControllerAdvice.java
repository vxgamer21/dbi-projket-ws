...
public class GlobalControllerAdvice {
    ...
    public ProblemDetail handleNotFound(ChangeSetPersister.NotFoundException ex, WebRequest request) {
        log.info("Not found: {}", ex.getMessage());
    ...
    public ResponseEntity<String> handleTransactionException(TransactionSystemException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Fehler bei Datenvalidierung: " + (cause != null ? cause.getMessage() : "Unbekannter Fehler"));
    }
}
