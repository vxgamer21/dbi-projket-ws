...
public class FixturesFactory {
    ...
    public static Arztpraxis ArztpraxisNoName() {
        return Arztpraxis.builder()
                .arztpraxisId(new Arztpraxis.ArztpraxisId(1L))
                .name("")
                .istKassenarzt(true)
    ...
    public static Patient StandardPatient() {
        return Patient.builder()
                .name("Max Mustermann")
    ...
    public static Arzt StandardArzt() {
        return Arzt.builder()
                .name("Dr. House")
                .gebDatum(LocalDate.of(1970, 6, 1))
                .svnr(987654321L)
                .fachgebiet(Fachgebiet.ALLGEMEINMEDIZIN)
                .adresse(Ringstrasse())
                .telefonNummer(StandardMobil())
                .email(new Email("house@hospital.com"))
                .build();
    }

    public static Rechnung StandardRechnung() {
        return Rechnung.builder()
                .patient(StandardPatient())
                .arzt(StandardArzt())
                .betrag(150.0)
                .bezahlt(false)
                .datum(LocalDateTime.of(2024, 1, 1, 10, 0))
                .build();
    }

    public static Rechnung BeispielRechnung(double betrag, boolean bezahlt, LocalDateTime datum) {
        return Rechnung.builder()
                .patient(StandardPatient())
                .arzt(StandardArzt())
                .betrag(betrag)
    ...
    public static Warteraum WarteRaumMitSitzplaetzen(int anzahl) {
        return Warteraum.builder()
                .anzahlSitzplaetze(anzahl)
                .build();
    }
